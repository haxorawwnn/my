...
__author__ = 'Shahwaiz Awan'
__copyright = 'All rights reserved . Copyright  Shahwaiz Awan'
...
os.system('clear')
logo ="""
\033[1;92m             888.                8888888.              888.               888888
\033[1;92m           88  88              88.                       88.   88.            888.      88
\033[1;92m         88      88            88.                     88.      88.           888.       88
\033[1;92m       888888888        88888888.      888888888.         888.       88  
\033[1;92m     88               88                    88.    88                88.      888.     88
\033[1;92m  888               888     88888888   888               888      888 88
\033[1;97m-----------------------------------------------
\033[1;92m➣ PROGRAMER   : Shahwaiz
\033[1;92m➣ FACEBOOK    : Filhal Nahi Hy
\033[1;92m➣ WHATSAPP    : Unknown
\033[1;92m➣. ID LINK.       :https://www.facebook.com/profile.php?id=100016563643273
\033[1;97m-----------------------------------------------"""
...
loop = 'true'
while (loop == 'true'):
    username = raw_input("\033[1;91m\x1b[1;91mENTER KEY.. \x1b[1;91m \x1b[1;91m")
...
def reg():
    ...
    print logo
    print("")
    print("   \x1b[1;92m            UPDATE BY ASAD")
    time.sleep(5)
    os.system('clear')
    print logo
    print ''
    ...
    r = requests.get('https://raw.githubusercontent.com/ASAD-ALI/Asad/main/server.txt').text
    if to in r:
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;93m     Asad Ali King Of Facebook     '
    print 47 * '-'
